...
if __name__ == '__main__':
    ...
    model.export(format="onnx", rect = False, quantize=8, data="/Users/zhangpeng/Desktop/workspace/github/ML-learning/yolo_det/datasets/Vegetable-Object-Detection/data.yaml")  # creates 'yolo26n_int8.onnx'
